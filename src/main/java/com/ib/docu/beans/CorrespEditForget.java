...
@Named
@ViewScoped
public class CorrespEditForget extends IndexUIbean  implements Serializable {	
	
	/**
	 * Заличаване данни на лица
	 * 
	 */
	private static final long serialVersionUID = -2053239996679153582L;
	private static final Logger LOGGER = LoggerFactory.getLogger(CorrespEditForget.class);
