		...
		try {
			...
			if (protUA == null && protDA == null) {
				...
				if (protUA != null) {
					...
					this.vidAndStatusArchive.put(this.protForUA, Integer.valueOf(DocuConstants.CODE_ZNACHENIE_DELO_STATUS_ARCHIVED_UA));
				}
				
				if (protDA != null) {
					this.protForDA = Integer.valueOf(protDA);
					this.vidAndStatusArchive.put(this.protForDA, Integer.valueOf(DocuConstants.CODE_ZNACHENIE_DELO_STATUS_ARCHIVED_DA));					
				}	
