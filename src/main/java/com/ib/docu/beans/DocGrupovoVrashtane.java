...
public class DocGrupovoVrashtane extends IndexUIbean {
	...
	private void initFields() {
		...
		this.returnMethod = DocuConstants.CODE_ZNACHENIE_PREDAVANE_NA_RAKA;
		this.returnInfo = "";
	...
	private boolean zabranenoVrashtane(DokumentDvijenie d) {
		return
			d.dvijMethod == DocuConstants.CODE_ZNACHENIE_PREDAVANE_SEOS
				||	d.dvijMethod == DocuConstants.CODE_ZNACHENIE_PREDAVANE_SSEV
				||	d.dvijMethod == DocuConstants.CODE_ZNACHENIE_PREDAVANE_EMAIL;
	...
	public boolean freeKorespRendered() {
		return this.returnMethod != DocuConstants.CODE_ZNACHENIE_PREDAVANE_SEOS
			&& this.returnMethod != DocuConstants.CODE_ZNACHENIE_PREDAVANE_SSEV
			&& this.returnMethod != DocuConstants.CODE_ZNACHENIE_PREDAVANE_DRUGA_REGISTRATURA;
	}
	...
	public void actionMethodChange() {
		if(this.selectionType != null) {
			...
			if(this.selectionType == SELECTED_TEXT && this.returnMethod == DocuConstants.CODE_ZNACHENIE_PREDAVANE_DRUGA_REGISTRATURA) {
				this.selectionType = null;
				this.freeKoresp = "";
				disableAdmStr(false);
				disableKorresp(false);
			...
			else if(this.selectionType == SELECTED_KORESP && this.returnMethod == DocuConstants.CODE_ZNACHENIE_PREDAVANE_DRUGA_REGISTRATURA) {
				actionKorrespClear();
				this.codeKorresp = null;
				this.textKorresp = null;
			}
