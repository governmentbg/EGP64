...
import com.ib.docu.search.ExtendedUserSearch;
...
public class GrantedRightsReport extends IndexUIbean  implements Serializable {
	...
	void initData() {
		...
		try {
			...
			item[0] = DocuConstants.CODE_CLASSIF_BUSINESS_ROLE; //кода
			...
			item[5] = getSystemData().getNameClassification(DocuConstants.CODE_CLASSIF_BUSINESS_ROLE,getCurrentLang());	
			rightsList.add(item);
			
			item = new Object [6];
			item[0] = DocuConstants.CODE_CLASSIF_REGISTRATURI;
			item[1] = new ArrayList<>();
			item[2] = new ArrayList<>();
			item[3] = new ArrayList<>();		
			item[4] = new ArrayList<>();
			item[5] = getSystemData().getNameClassification(DocuConstants.CODE_CLASSIF_REGISTRATURI,getCurrentLang());
			rightsList.add(item);
			
			item = new Object [6];
			item[0] = DocuConstants.CODE_CLASSIF_REGISTRI;
			item[1] = new ArrayList<>();
			item[2] = new ArrayList<>();
			item[3] = new ArrayList<>();
			item[4] = new ArrayList<>();
			item[5] = getSystemData().getNameClassification(DocuConstants.CODE_CLASSIF_REGISTRI,getCurrentLang());
			rightsList.add(item);
			...
			item = new Object [6];
			item[0] = DocuConstants.CODE_CLASSIF_USER_SETTINGS;
			item[1] = new ArrayList<>();
			item[2] = new ArrayList<>();
			item[3] = new ArrayList<>();
			item[4] = new ArrayList<>();
			item[5] = getSystemData().getNameClassification(DocuConstants.CODE_CLASSIF_USER_SETTINGS,getCurrentLang());
			rightsList.add(item);
			
			item = new Object [6];
			item[0] = DocuConstants.CODE_CLASSIF_NOTIFF_EVENTS_ACTIVE;
			item[1] = new ArrayList<>();
			item[2] = new ArrayList<>();
			item[3] = new ArrayList<>();
			item[4] = new ArrayList<>();
			item[5] = getSystemData().getNameClassification(DocuConstants.CODE_CLASSIF_NOTIFF_EVENTS_ACTIVE,getCurrentLang());	
			rightsList.add(item);
