...
import com.ib.docu.db.dao.RegisterDAO;
...
public class RegisterData extends IndexUIbean  implements Serializable {			
	...
	public void actionEdit(Integer idObj) {
		...
		try {
			...
			if (idObj != null) {
				...
				if(Objects.equals(this.register.getValid(), DocuConstants.CODE_ZNACHENIE_DA)) {
				...
				if(Objects.equals(this.register.getCommon(), DocuConstants.CODE_ZNACHENIE_DA)) {
	...
	public boolean checkData() {
		...
		if(this.register.getBegNomer() == null && (this.register.getAlg() != null && this.register.getAlg().equals(DocuConstants.CODE_ZNACHENIE_ALG_INDEX_STEP))) { 
		...
		if(this.register.getActNomer() == null && (this.register.getAlg() != null && this.register.getAlg().equals(DocuConstants.CODE_ZNACHENIE_ALG_INDEX_STEP))) {
		...
		if(this.register.getStep() == null && (this.register.getAlg() != null && this.register.getAlg().equals(DocuConstants.CODE_ZNACHENIE_ALG_INDEX_STEP))) {
	...
	public void actionSave() {
		...
		try {
			...
			getSystemData().reloadClassif(DocuConstants.CODE_CLASSIF_REGISTRI, false, false);
			getSystemData().reloadClassif(DocuConstants.CODE_CLASSIF_REGISTRI_SORTED, false, false);
			getSystemData().reloadClassif(DocuConstants.CODE_CLASSIF_REGISTRATURI, false, false);
...
//			}
	...
	public void actionFindAllRegistraturi() {
		...
		try {
			...
			this.classifRegsList = getSystemData().queryClassification(DocuConstants.CODE_CLASSIF_REGISTRATURI, null, new Date(), getCurrentLang(), notInCodes);
