...
//				Integer idObj = Integer.valueOf(JSFUtils.getRequestParameter(ID_OBJ));	
				...
				if (idObj != null) {
					...
					if(Objects.equals(this.registratura.getValid(), DocuConstants.CODE_ZNACHENIE_DA)) {
						this.activeReg = true;
...
//			}
	...
	public void actionSave() {
		...
		try {
			...
			getSystemData().reloadClassif(DocuConstants.CODE_CLASSIF_REGISTRATURI_OBJACCESS, false, false);
			getSystemData().reloadClassif(DocuConstants.CODE_CLASSIF_REGISTRATURI_REQDOC, false, false);
