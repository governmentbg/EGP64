...
//				try {
//					Integer codeClassif = DocuConstants.CODE_CLASSIF_ADMIN_STR;
//					if (codeClassif != null) {
//						
...
//	private Map<Integer, Object> specificsAdm = Collections.singletonMap(DocuClassifAdapter.ADM_STRUCT_INDEX_REF_TYPE
//			, X.of(DocuConstants.CODE_ZNACHENIE_REF_TYPE_EMPL)); //  така ще дава само служители през аутокомплете, а в дървото ще е цялата
//
//	
