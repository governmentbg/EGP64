...
//	}
	...
	private void onNodeSelectAdmGr(NodeSelectEvent event)  {
		...
		String emplCodes;
		try {
			emplCodes = (String) getSystemData().getItemSpecific(DocuConstants.CODE_CLASSIF_GROUP_EMPL, selectedItem.getCode(), SysConstants.CODE_DEFAULT_LANG, getDateClassif(), DocuClassifAdapter.REG_GROUP_INDEX_MEMBERS);
