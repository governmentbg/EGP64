...
import static com.ib.docu.system.DocuConstants.CODE_ZNACHENIE_DELO_SECTION_OFFICIAL;
...
public class DeloDocDAO extends AbstractDAO<DeloDoc> {
	...
	public void delete(DeloDoc entity) throws DbErrorException, ObjectInUseException {
		...
		new DocDostUtils().removeDocDostFromObject(entity.getInputDocId(), DocuConstants.CODE_ZNACHENIE_JOURNAL_DELO, entity.getDeloId());
	...
	public String checkCreateDvij(DeloDoc deloDoc, BaseSystemData systemData) throws DbErrorException {
			...
			rows = createNativeQuery( //
				"select ID, DVIJ_DATE, CODE_REF, DVIJ_TEXT, FROM_DVIJ_ID from DELO_DVIJ" //
					...
					+ " order by 2 desc, 1 desc") //
						...
						.setParameter(3, DocuConstants.CODE_ZNACHENIE_PREDAVANE_NA_RAKA) //
		...
		dvij.setDvijMethod(DocuConstants.CODE_ZNACHENIE_PREDAVANE_NA_RAKA);
