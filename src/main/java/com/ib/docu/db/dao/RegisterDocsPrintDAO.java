...
//				String title = "LABELS";	
	...
	// || , TO_CHAR, NVL, -> dialect			
				select.append( 
						...
						"CASE WHEN d.DOC_TYPE = "+DocuConstants.CODE_ZNACHENIE_DOC_TYPE_IN+" THEN null ELSE "+
						DialectConstructor.convertToDelimitedString(dialect, "dr.CODE_REF", "DOC_REFERENTS dr where dr.DOC_ID = d.DOC_ID and dr.ROLE_REF ="+DocuConstants.CODE_ZNACHENIE_DOC_REF_ROLE_AUTHOR+" ", "+dr.PORED")+" END A12, " +
				...
				from.append(
					"FROM "+
					"DOC d "+ 
					"LEFT OUTER JOIN LOCK_OBJECTS z on z.OBJECT_TIP = "+DocuConstants.CODE_ZNACHENIE_JOURNAL_DOC+" and z.OBJECT_ID = d.DOC_ID and z.USER_ID <> "+ getUserId() +" "+ 
					...
					"LEFT OUTER JOIN SYSTEM_CLASSIF sct on sct.CODE_CLASSIF = "+DocuConstants.CODE_CLASSIF_DOC_TYPE+" and d.DOC_TYPE=sct.CODE and sct.DATE_DO is null "+ 
					"LEFT OUTER JOIN SYSTEM_CLASSIF scv on scv.CODE_CLASSIF = "+DocuConstants.CODE_CLASSIF_DOC_VID+" and d.DOC_VID=scv.CODE and scv.DATE_DO is null "+
					"LEFT OUTER JOIN SYSTEM_CLASSIF scs on scs.CODE_CLASSIF = "+DocuConstants.CODE_CLASSIF_DOC_VALID+" and d.VALID=scs.CODE and scs.DATE_DO is null "+
					"LEFT OUTER JOIN SYSTEM_CLASSIF sci on sci.CODE_CLASSIF = "+DocuConstants.CODE_CLASSIF_DOC_IRREGULAR+" and d.IRREGULAR=sci.CODE and sci.DATE_DO is null "+
					"LEFT OUTER JOIN SYSTEM_CLASSIF scst on scst.CODE_CLASSIF = "+DocuConstants.CODE_CLASSIF_DOC_STATUS+" and d.STATUS=scst.CODE and scst.DATE_DO is null "+ 
		...
		public List<Object[]> selDestrDocs(Integer idDoc) throws DbErrorException {
			try {
				...
				from.append(
					...
					"LEFT OUTER JOIN SYSTEM_CLASSIF scv1 on scv1.CODE_CLASSIF = "+DocuConstants.CODE_CLASSIF_DOC_VID+" and d.DOC_VID=scv1.CODE and scv1.DATE_DO is null "+
					"LEFT OUTER JOIN SYSCLASSIF_MULTILANG slv1 on slv1.TEKST_KEY=scv1.TEKST_KEY and slv1.LANG="+getUserLang()+ " " +
					
					"LEFT OUTER JOIN SYSTEM_CLASSIF scs1 on scs1.CODE_CLASSIF = "+DocuConstants.CODE_CLASSIF_DOC_VID+" and dof.DOC_VID=scs1.CODE and scs1.DATE_DO is null "+
		...
		public List<Object[]> selArhivDocs(Integer idDoc) throws DbErrorException {
			try {
				...
				from.append(
					...
					"LEFT OUTER JOIN SYSTEM_CLASSIF sct1 on sct1.CODE_CLASSIF = "+DocuConstants.CODE_CLASSIF_DOC_VID+" and dp.DOC_VID=sct1.CODE and sct1.DATE_DO is null "+
					"LEFT OUTER JOIN SYSCLASSIF_MULTILANG slt1 on slt1.TEKST_KEY=sct1.TEKST_KEY and slt1.LANG="+getUserLang()+ " "+
					
					"LEFT OUTER JOIN SYSTEM_CLASSIF scv2 on scv2.CODE_CLASSIF = "+DocuConstants.CODE_CLASSIF_DOC_VID+" and dof.DOC_VID=scv2.CODE and scv2.DATE_DO is null "+
					"LEFT OUTER JOIN SYSCLASSIF_MULTILANG slv2 on slv2.TEKST_KEY=scv2.TEKST_KEY and slv2.LANG="+getUserLang()+ " " +
					
					"LEFT OUTER JOIN SYSTEM_CLASSIF scd on scd.CODE_CLASSIF = "+DocuConstants.CODE_CLASSIF_DELO_TYPE+" and d.delo_type=scd.CODE and scd.DATE_DO is null " + 
...
//				String dialect = JPA.getUtil().getDbVendorName();
				...
				from.append(" from "+
						...
						"join delo d on d.delo_id=dd.delo_id " + 
						"LEFT OUTER JOIN SYSTEM_CLASSIF sct2 on sct2.CODE_CLASSIF = "+DocuConstants.CODE_CLASSIF_DELO_TYPE+" and d.delo_type=sct2.CODE and sct2.DATE_DO is null " + 
		...
		public List<Object[]> selDvigDocs(Integer idDoc) throws DbErrorException {
			try {
				...
				from.append(
					...
					/*"LEFT OUTER JOIN SYSTEM_CLASSIF scm on scm.CODE_CLASSIF = "+DocuConstants.CODE_CLASSIF_DVIJ_METHOD+" and dd.DVIJ_METHOD=scm.CODE and scm.DATE_DO is null "+
					"LEFT OUTER JOIN SYSCLASSIF_MULTILANG lmt on lmt.TEKST_KEY=scm.TEKST_KEY and lmt.LANG="+getUserLang()+ " "+
					
					"LEFT OUTER JOIN SYSTEM_CLASSIF scmr on scmr.CODE_CLASSIF = "+DocuConstants.CODE_CLASSIF_DVIJ_METHOD+" and dd.RETURN_METHOD=scmr.CODE and scmr.DATE_DO is null "+ 
					"LEFT OUTER JOIN SYSCLASSIF_MULTILANG lmtr on lmtr.TEKST_KEY=scmr.TEKST_KEY and lmtr.LANG="+getUserLang()+ " "+*/
					
					"LEFT OUTER JOIN SYSTEM_CLASSIF scs2 on scs2.CODE_CLASSIF = "+DocuConstants.CODE_CLASSIF_DOC_PREDAVANE_STATUS+" and dd.STATUS=scs2.CODE and scs2.DATE_DO is null "+
		...
		public List<Object[]> selPrilDocs(Integer idDoc) throws DbErrorException {
			...
			try {
				...
				from.append(" from DOC_PRIL p "+
						"LEFT OUTER JOIN SYSTEM_CLASSIF scs3 on scs3.CODE_CLASSIF = "+DocuConstants.CODE_CLASSIF_MEDIA_TYPE+" and p.MEDIA_TYPE=scs3.CODE and scs3.DATE_DO is null "+
		...
		public List<Object[]> selLinkDocs(Integer idDoc) throws DbErrorException {
			...
			try {
				...
				from.append(" from "+
						...
						"LEFT OUTER JOIN SYSTEM_CLASSIF scs4 on scs4.CODE_CLASSIF = "+DocuConstants.CODE_CLASSIF_DOC_REL_TYPE+" and dd.REL_TYPE=scs4.CODE and scs4.DATE_DO is null "+
