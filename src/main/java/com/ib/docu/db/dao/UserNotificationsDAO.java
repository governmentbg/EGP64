...
public class UserNotificationsDAO  {
	 ...
	 * 
	 * @param userId
	 * @param status DocuConstants.CODE_NOTIF_STATUS_NEPROCHETENA
	 * @param registratura 
	 * @return
	 ...
	 * @param status - прочететно/непрочетено (в DocuConstants  -> CODE_NOTIF_STATUS_NEPROCHETENA/CODE_NOTIF_STATUS_PROCHETENA)
	 * @return
	 * @throws DbErrorException
	 */
	@SuppressWarnings("unchecked")
	...
	void journalNotifDelete(Integer userId, List<Object[]> selected, BaseSystemData sd) throws DbErrorException {
		for (Object[] row : selected) {
			...
			SystemJournal journal = new SystemJournal(userId, CODE_DEIN_IZTRIVANE, DocuConstants.CODE_ZNACHENIE_JOURNAL_NOTIF, id, identObject, null);
