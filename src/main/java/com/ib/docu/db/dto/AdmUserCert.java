...
public class AdmUserCert extends TrackableEntity implements AuditExt{
	...
	@Column(name = "USER_ID")
	@JournalAttr(label = "userId", defaultText = "Потребител", codeObject = DocuConstants.CODE_ZNACHENIE_JOURNAL_USER)
	...
	@JournalAttr(label="activeCert",defaultText = "Активен", classifID = ""+ DocuConstants.CODE_CLASSIF_DANE)
	...
	public Integer getCodeMainObject() {
		return DocuConstants.CODE_ZNACHENIE_JOURNAL_USER_CERT;
	}
	...
	public SystemJournal toSystemJournal() throws DbErrorException {
		...
		dj.setJoinedCodeObject1(DocuConstants.CODE_ZNACHENIE_JOURNAL_USER);
