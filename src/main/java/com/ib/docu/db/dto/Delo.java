...
import static com.ib.docu.system.DocuConstants.CODE_ZNACHENIE_DELO_STATUS_ACTIVE;
import static com.ib.docu.system.DocuConstants.CODE_ZNACHENIE_DELO_TYPE_DOSS;
import static com.ib.docu.system.DocuConstants.CODE_ZNACHENIE_JOURNAL_DELO;
import static com.ib.docu.system.DocuConstants.CODE_ZNACHENIE_REISTRATURA_SETTINGS_14;
...
@Entity
@Table(name = "DELO")
public class Delo extends TrackableEntity implements AuditExt{
	/**  */
	...
	@JournalAttr(label="initDocId",defaultText = "Иницииращ док.", codeObject = DocuConstants.CODE_ZNACHENIE_JOURNAL_DOC)
	private Integer initDocId;

	@Column(name = "CODE_REF_LEAD")
	@JournalAttr(label = "codeRefLead",defaultText = "Водещ служител", classifID = ""+DocuConstants.CODE_CLASSIF_ADMIN_STR)
	...
	@JournalAttr(label = "deloType", defaultText = "Тип",classifID = ""+DocuConstants.CODE_CLASSIF_DELO_TYPE)
	...
	@JournalAttr(label = "status",defaultText = "Статус",classifID = ""+DocuConstants.CODE_CLASSIF_DELO_STATUS)
	...
	@JournalAttr(label = "withSection",defaultText = "с раздели", classifID = ""+ DocuConstants.CODE_CLASSIF_DANE)
	private Integer withSection;

	@Column(name = "WITH_TOM")
	@JournalAttr(label = "withTom",defaultText = "С томове", classifID = ""+ DocuConstants.CODE_CLASSIF_DANE)
