...
public class DeloArchive implements PersistentEntity, AuditExt {
	...
	@JournalAttr(label = "protocolId", defaultText = "Раб. протокол", codeObject = DocuConstants.CODE_ZNACHENIE_JOURNAL_DOC)
	@Column(name = "PROTOCOL_ID")
	private Integer protocolId;

	@JournalAttr(label = "docId", defaultText = "Ном. дело", codeObject = DocuConstants.CODE_ZNACHENIE_JOURNAL_DELO)
	@Column(name = "DELO_ID")
	...
	public Integer getCodeMainObject() {
		return DocuConstants.CODE_ZNACHENIE_JOURNAL_DELO_ARCHIVE;
	}
	...
	public SystemJournal toSystemJournal() throws DbErrorException {
		...
		journal.setJoinedCodeObject2(DocuConstants.CODE_ZNACHENIE_JOURNAL_DELO);
