...
public class DeloDelo extends TrackableEntity implements AuditExt {
	...
	@JournalAttr(label = "deloId",defaultText = "Дело, в което се влага", codeObject = DocuConstants.CODE_ZNACHENIE_JOURNAL_DELO)
	private Integer deloId;

	@Column(name = "INPUT_DELO_ID", updatable = false)
	@JournalAttr(label = "inputDeloId",defaultText = "Дело, което е вложено", codeObject = DocuConstants.CODE_ZNACHENIE_JOURNAL_DELO)
...
//	}
	...
	public Integer getCodeMainObject() {
		return DocuConstants.CODE_ZNACHENIE_JOURNAL_DELO_DELO;
	}
	...
	public SystemJournal toSystemJournal() throws DbErrorException {
		...
		dj.setJoinedCodeObject2(DocuConstants.CODE_ZNACHENIE_JOURNAL_DELO);
