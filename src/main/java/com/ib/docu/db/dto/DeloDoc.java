...
public class DeloDoc extends TrackableEntity implements AuditExt{
	...
	@JournalAttr(label = "deloID",defaultText = "Дело", codeObject = DocuConstants.CODE_ZNACHENIE_JOURNAL_DELO)
	private Integer deloId;

	@Column(name = "INPUT_DOC_ID", updatable = false)
	@JournalAttr(label = "inputDocId",defaultText = "Документ", codeObject = DocuConstants.CODE_ZNACHENIE_JOURNAL_DOC)
	...
	public Integer getCodeMainObject() {
		return DocuConstants.CODE_ZNACHENIE_JOURNAL_DELO_DOC;
	}
