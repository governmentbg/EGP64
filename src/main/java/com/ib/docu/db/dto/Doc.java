...
public class Doc extends TrackableEntity implements AuditExt{
	...
	@JournalAttr(label="workOffId",defaultText = "Работен/официален документ", codeObject = DocuConstants.CODE_ZNACHENIE_JOURNAL_DOC)
	...
	@JournalAttr(label="forRegId",defaultText = "За регистрация в",classifID = ""+ DocuConstants.CODE_CLASSIF_REGISTRATURI)
	private Integer forRegId;

	@Column(name = "PRE_FOR_REG_ID")
	@JournalAttr(label="preForRegId",defaultText = "Предварително избрана регистртура за регистрация",classifID = ""+ DocuConstants.CODE_CLASSIF_REGISTRATURI)
	...
	@Column(name = "VALID")
	@JournalAttr(label="valid",defaultText = "Валидност", classifID = ""+ DocuConstants.CODE_CLASSIF_DOC_VALID)
	...
	@Column(name = "STATUS")
	@JournalAttr(label="status",defaultText = "Статус", classifID = ""+ DocuConstants.CODE_CLASSIF_DOC_STATUS)
	...
	@Column(name = "URGENT")
	@JournalAttr(label="urgent",defaultText = "Спешност", classifID = ""+ DocuConstants.CODE_CLASSIF_URGENT)
	private Integer urgent;

	@Column(name = "PROCESSED")
	@JournalAttr(label="processed",defaultText = "Обработен", classifID = ""+ DocuConstants.CODE_CLASSIF_DANE)
	private Integer processed;

	@Column(name = "IRREGULAR")
	@JournalAttr(label="irregular",defaultText = "Причини за нередовност", classifID = ""+ DocuConstants.CODE_CLASSIF_DOC_IRREGULAR)
	private Integer irregular;

	@Column(name = "FREE_ACCESS")
	@JournalAttr(label="freeAccess",defaultText = "Свободен достъп", classifID = ""+ DocuConstants.CODE_CLASSIF_DANE)
	...
	@JournalAttr(label="signMethod",defaultText = "Начин на подписване",classifID = ""+ DocuConstants.CODE_CLASSIF_DOC_SIGN_METHOD)
	...
	/**
	 * ROLE_REF=2 {@link DocuConstants#CODE_ZNACHENIE_DOC_REF_ROLE_AGREED}
	 *
	...
	/**
	 * ROLE_REF=1 {@link DocuConstants#CODE_ZNACHENIE_DOC_REF_ROLE_AUTHOR}
	 *
	...
	/**
	 * ROLE_REF=3 {@link DocuConstants#CODE_ZNACHENIE_DOC_REF_ROLE_SIGNED}
	 *
