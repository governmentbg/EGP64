...
public class DocDoc extends TrackableEntity implements AuditExt{
	...
	@JournalAttr(label = "docId1", defaultText = "Документ 1", codeObject = DocuConstants.CODE_ZNACHENIE_JOURNAL_DOC)
	...
	@JournalAttr(label = "docId1", defaultText = "Документ 2", codeObject = DocuConstants.CODE_ZNACHENIE_JOURNAL_DOC)
	private Integer docId2;
	
	/** */
	@Override
	public Integer getCodeMainObject() {
		return DocuConstants.CODE_ZNACHENIE_JOURNAL_DOC_DOC;
	}
