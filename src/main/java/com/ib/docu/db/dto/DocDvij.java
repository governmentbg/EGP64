...
public class DocDvij extends TrackableEntity implements AuditExt{
	...
	@JournalAttr(label = "forRegid", defaultText = "За регистриране в ",classifID = ""+DocuConstants.CODE_CLASSIF_REGISTRATURI)
...
//	private Date confirmDate;
	...
	public Integer getCodeMainObject() {
		...
		return DocuConstants.CODE_ZNACHENIE_JOURNAL_DOC_DVIJ;
	}
