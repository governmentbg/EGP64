...
public class DocMember extends TrackableEntity implements AuditExt {
	...
	@JournalAttr(label = "refType", defaultText = "Вид участник", classifID = "" + DocuConstants.CODE_CLASSIF_REF_TYPE)
	private Integer refType;

	@Column(name = "ROLE_REF")
	@JournalAttr(label = "roleRef", defaultText = "Роля на участник", classifID = "" + DocuConstants.CODE_CLASSIF_DOC_MEMBER_ROLES)
	...
	public Integer getCodeMainObject() {
		return DocuConstants.CODE_ZNACHENIE_JOURNAL_DOC_MEMBER;
	}
