...
public class DocShema extends TrackableEntity implements AuditExt {
	...
	@JournalAttr(label = "docSchema.termStore", defaultText = "Срок за съхранение", classifID = "" + DocuConstants.CODE_CLASSIF_SHEMA_PERIOD)
	...
	@JournalAttr(label = "docSchema.complMethodLong", defaultText = "Начин на приключване на номенклатурно дело", classifID = "" + DocuConstants.CODE_CLASSIF_NOM_DELO_PRIKL)
	...
	public Integer getCodeMainObject() {
		return DocuConstants.CODE_ZNACHENIE_JOURNAL_DOC_SHEMA;
	}
