...
//	@JournalAttr(label = "registraturaId", defaultText = "ИД на регистратура")
	...
	@JournalAttr(label = "docVidSetting.shemaId", defaultText = "Индекс на номенклатурно дело за съхранение на документ от този вид", classifID = "" + DocuConstants.CODE_CLASSIF_DOC_SHEMA)
	@Column(name = "SHEMA_ID")
	private Integer shemaId;

	@JournalAttr(label = "docVidSetting.typeDoc", defaultText = "Вид документ", classifID = "" + DocuConstants.CODE_CLASSIF_DOC_VID)
	@Column(name = "DOC_VID")
	private Integer docVid;

	@JournalAttr(label = "docu.register", defaultText = "Регистър", classifID = "" + DocuConstants.CODE_CLASSIF_REGISTRI)
	...
	@JournalAttr(label = "docVidSetting.regOfficDocThisType", defaultText = "Регистратура за заявка за деловодна регистрация", classifID = "" + DocuConstants.CODE_CLASSIF_REGISTRATURI)
	...
	@JournalAttr(label = "docVidSetting.docProceed", defaultText = "Начин на обработка на документ", classifID = "" + DocuConstants.CODE_CLASSIF_DOC_PROCEED)
	...
	@JournalAttr(label = "missing.procDefIn", defaultText = "Стартира процедура: за входящ документ", classifID = "" + DocuConstants.CODE_CLASSIF_PROCEDURI)
	@Column(name = "PROC_DEF_IN")
	private Integer procDefIn;

	@JournalAttr(label = "missing.procDefOwn", defaultText = "Стартира процедура: за собствен документ", classifID = "" + DocuConstants.CODE_CLASSIF_PROCEDURI)
	@Column(name = "PROC_DEF_OWN")
	private Integer procDefOwn;

	@JournalAttr(label = "missing.procDefWork", defaultText = "Стартира процедура: за работен документ", classifID = "" + DocuConstants.CODE_CLASSIF_PROCEDURI)
	@Column(name = "PROC_DEF_WORK")
	private Integer procDefWork;

	@JournalAttr(label = "docVidSettings.characterSpecDoc", defaultText = "Характер на специализиран документ", classifID = "" + DocuConstants.CODE_CLASSIF_CHARACTER_SPEC_DOC)
	@Column(name = "DOC_HAR")
	...
	public Integer getCodeMainObject() {
		return DocuConstants.CODE_ZNACHENIE_JOURNAL_DOC_VID_SETT;
	}
	...
	public SystemJournal toSystemJournal() throws DbErrorException {
		...
		journal.setJoinedCodeObject1(DocuConstants.CODE_ZNACHENIE_JOURNAL_REISTRATURA);
