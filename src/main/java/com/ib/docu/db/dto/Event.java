...
public class Event extends TrackableEntity implements AuditExt {
	...
	@JournalAttr(label = "events.vid", defaultText = "Вид организирано събитие", classifID = "" + DocuConstants.CODE_CLASSIF_VID_EVENT)
...
//	@JournalAttr(label = "dateLastNotif", defaultText = "Време на последна нотификация за нови материали", dateMask = "dd.MM.yyyy HH:mm:ss")
	...
	@JournalAttr(label = "events.resourses", defaultText = "Ресурси", classifID = "" + DocuConstants.CODE_CLASSIF_EVENT_RESOURCES)
	@Transient
	...
	public Integer getCodeMainObject() {
		return DocuConstants.CODE_ZNACHENIE_JOURNAL_EVENT;
	}
