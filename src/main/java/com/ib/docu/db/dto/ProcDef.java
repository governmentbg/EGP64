...
public class ProcDef extends TrackableEntity implements AuditExt {
	...
	@Column(name = "STATUS")
	@JournalAttr(label = "status", defaultText = "Статус", classifID = "" + DocuConstants.CODE_CLASSIF_PROC_DEF_STAT)
	...
	@JournalAttr(label = "businessRole", defaultText = "Отговорен - Бизнес роля", classifID = "" + DocuConstants.CODE_CLASSIF_PROC_BUSINESS_ROLE)
	...
	public Integer getCodeMainObject() {
		return DocuConstants.CODE_ZNACHENIE_JOURNAL_PROC_DEF;
	}
