...
public class ProcDefEtap extends TrackableEntity implements AuditExt {
	...
	@JournalAttr(label = "businessRole", defaultText = "Контролиращ - Бизнес роля", classifID = "" + DocuConstants.CODE_CLASSIF_PROC_BUSINESS_ROLE)
	...
	@JournalAttr(label = "etapDocMode", defaultText = "Тип стартиращ документ ", classifID = "" + DocuConstants.CODE_CLASSIF_ETAP_DOC_MODE)
...
//	[0]-id; [1]-nomer; [2]-etapName
	...
	public Integer getCodeMainObject() {
		return DocuConstants.CODE_ZNACHENIE_JOURNAL_PROC_DEF_ETAP;
	}
	...
	public SystemJournal toSystemJournal() throws DbErrorException {
		...
		dj.setJoinedCodeObject1(DocuConstants.CODE_ZNACHENIE_JOURNAL_PROC_DEF);
