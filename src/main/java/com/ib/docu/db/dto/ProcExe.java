...
public class ProcExe extends TrackableEntity implements AuditExt {
	...
	@JournalAttr(label = "defId", defaultText = "Дефиниция", classifID = "" + DocuConstants.CODE_CLASSIF_PROCEDURI)
	...
	@JournalAttr(label = "docId", defaultText = "Инициращ документ", codeObject = DocuConstants.CODE_ZNACHENIE_JOURNAL_DOC)
	@Column(name = "DOC_ID")
	private Integer docId;

	@JournalAttr(label = "status", defaultText = "Статус", classifID = "" + DocuConstants.CODE_CLASSIF_PROC_STAT)
	@Column(name = "STATUS")
	...
	@Transient
	private Integer lastTaskExec; // това е помощно поле, където ще се сетва кой е изпълнителя на задачата при прилкючване на етап
									// и когато се налага в зависимост от ролята на следващите етапи ще се използва
	...
	/** @return the lastTaskExec */
	public Integer getLastTaskExec() {
		return this.lastTaskExec;
	}
	...
	/** @param lastTaskExec the lastTaskExec to set */
	public void setLastTaskExec(Integer lastTaskExec) {
		this.lastTaskExec = lastTaskExec;
	}
