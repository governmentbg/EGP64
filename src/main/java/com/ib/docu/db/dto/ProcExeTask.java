...
public class ProcExeTask implements PersistentEntity, AuditExt {
	...
	@JournalAttr(label = "taskId", defaultText = "Задача", codeObject = DocuConstants.CODE_ZNACHENIE_JOURNAL_TASK)
	@Column(name = "TASK_ID")
	...
	public Integer getCodeMainObject() {
		return DocuConstants.CODE_ZNACHENIE_JOURNAL_PROC_EXE_TASK;
	}
	...
	public SystemJournal toSystemJournal() throws DbErrorException {
		...
		journal.setJoinedCodeObject1(DocuConstants.CODE_ZNACHENIE_JOURNAL_PROC_EXE_ETAP);
