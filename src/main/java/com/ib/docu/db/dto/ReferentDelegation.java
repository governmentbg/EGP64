...
public class ReferentDelegation extends TrackableEntity implements AuditExt {
	...
	@JournalAttr(label = "users.registratura", defaultText = "Регистратура", classifID = "" + DocuConstants.CODE_CLASSIF_REGISTRATURI)
	...
	@JournalAttr(label = "missing.delegationType", defaultText = "Вид делегирано право", classifID = "" + DocuConstants.CODE_CLASSIF_DELEGATES)
	...
	public Integer getCodeMainObject() {
		return DocuConstants.CODE_ZNACHENIE_JOURNAL_DELEGATION;
	}
