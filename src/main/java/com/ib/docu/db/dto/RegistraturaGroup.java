...
public class RegistraturaGroup extends TrackableEntity implements AuditExt {
	...
	@JournalAttr(label = "groupType", defaultText = "Тип на групата", classifID = "" + DocuConstants.CODE_CLASSIF_REGISTRATURA_GROUP_TYPE)
	...
	public Integer getCodeMainObject() {
		return DocuConstants.CODE_ZNACHENIE_JOURNAL_REISTRATURA_GROUP;
	}
	...
	public String getIdentInfo() throws DbErrorException {
		...
		if (this.groupType.equals(DocuConstants.CODE_ZNACHENIE_REG_GROUP_TYPE_CORRESP)) {
			groupTypeText = "група лица";
		} else if (this.groupType.equals(DocuConstants.CODE_ZNACHENIE_REG_GROUP_TYPE_EMPL)) {
			groupTypeText = "група служители";
		} else if (this.groupType.equals(DocuConstants.CODE_ZNACHENIE_REG_GROUP_TYPE_SEOS)) {
