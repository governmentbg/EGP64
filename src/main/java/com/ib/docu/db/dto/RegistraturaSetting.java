...
//	@JournalAttr(label = "registraturaId", defaultText = "ИД на регистратура")
	...
	@JournalAttr(label = "regSettings.setting", defaultText = "Настройка", classifID = "" + DocuConstants.CODE_CLASSIF_REISTRATURA_SETTINGS)
	...
	public Integer getCodeMainObject() {
		return DocuConstants.CODE_ZNACHENIE_JOURNAL_REISTRATURA_SETT;
	}
