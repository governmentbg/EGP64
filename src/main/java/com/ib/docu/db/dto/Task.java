...
public class Task extends TrackableEntity implements AuditExt{
	/**  */
	...
	@JournalAttr(label="docId",defaultText = "Документ", codeObject = DocuConstants.CODE_ZNACHENIE_JOURNAL_DOC)
	private Integer docId;
	
	@Column(name = "END_DOC_ID")
	@JournalAttr(label="endDocId",defaultText = "Документ при приключване", codeObject = DocuConstants.CODE_ZNACHENIE_JOURNAL_DOC)
	...
	@JournalAttr(label="docRequired",defaultText = "Изисква документ", classifID = ""+ DocuConstants.CODE_CLASSIF_DANE)
...
//	@JournalAttr(label="dateDocEnd",defaultText = "Дата на документ при приключване", dateMask = "dd.MM.yyyy HH:mm:ss")
	...
	public SystemJournal toSystemJournal() throws DbErrorException {
		...
		if (endDocId != null ) {
			dj.setJoinedCodeObject2(DocuConstants.CODE_ZNACHENIE_JOURNAL_DOC);
