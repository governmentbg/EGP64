...
public class TaskSchedule extends TrackableEntity implements AuditExt {
	...
	@JournalAttr(label = "regPeriod", defaultText = "Вид периодичност", classifID = "" + DocuConstants.CODE_CLASSIF_TASK_PERIOD)
	...
	@JournalAttr(label = "docId", defaultText = "Документ на задача", codeObject = DocuConstants.CODE_ZNACHENIE_JOURNAL_DOC)
	@Column(name = "DOC_ID")
	...
	public Integer getCodeMainObject() {
		return DocuConstants.CODE_ZNACHENIE_JOURNAL_TASK_SCHEDULE;
	}
