...
import com.ib.docu.db.dto.NotificationPatternVariables;
...
public class Notification {
	...
	private String  getAttr(String attr, Integer codeClassif) {
		...
		try {
			...
			if (tekClass instanceof Integer && codeClassif != null) {
				return sd.decodeItem(codeClassif, (Integer)tekClass, DocuConstants.CODE_DEFAULT_LANG, new Date());
			}
	...
	public void generateNotif() throws DbErrorException {
		...
		if (mess.getIdObject() == null && procId != null) {
			mess.setCodeObject(DocuConstants.CODE_ZNACHENIE_JOURNAL_PROC_EXE);
