...
import static com.ib.docu.system.DocuConstants.CODE_ZNACHENIE_NOTIFF_EVENTS_UNAUTHORIZED_PAGE;
...
public class UserData extends BaseUserData {
	...
	/**
	 * ако логнатия е с ръководна длъжност {@link DocuConstants#CODE_CLASSIF_BOSS_POSITIONS}, то тука ще влезнат списък на звената
