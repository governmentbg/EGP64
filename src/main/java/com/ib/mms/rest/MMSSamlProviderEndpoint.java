...
import com.ib.system.rest.SamlRestEndpoint2_0;
 ...
 */
@Path("/eauth")
public class MMSSamlProviderEndpoint extends SamlRestEndpoint2_0 {
     ...
     */
    @Override
    protected Credential findUserByEmail(EntityManager manager, String userInfo) throws DbErrorException {
    	...
    	Query q = manager.createNativeQuery("select u.user_id from ADM_USERS u where u.email='" +  userInfo + "'");
