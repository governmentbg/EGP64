...
public class TestTaskScheduleDAO {
	...
	public void testListNextNRegistration() {
		...
		this.schedule.setRegPeriod(DocuConstants.CODE_ZNACHENIE_TASK_PERIOD_MONTH);
...
//	@Test
	public void testSaveTaskScheduleDay() {
		...
		this.schedule.setTaskType(1);
		this.schedule.setRegPeriod(DocuConstants.CODE_ZNACHENIE_TASK_PERIOD_DAY);
...
//	@Test
	public void testSaveTaskScheduleWeek() {
		...
		this.schedule.setTaskType(1);
		this.schedule.setRegPeriod(DocuConstants.CODE_ZNACHENIE_TASK_PERIOD_WEEK);
...
//	@Test
	public void testSaveTaskScheduleYear() {
		...
		this.schedule.setTaskType(1);
		this.schedule.setRegPeriod(DocuConstants.CODE_ZNACHENIE_TASK_PERIOD_YEAR);
		this.schedule.setRegInterval(1); // всяки месец
		this.schedule.setRegDay(10); // десето число
