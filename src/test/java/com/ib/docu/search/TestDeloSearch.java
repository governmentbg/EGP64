...
public class TestDeloSearch {
	...
	public void testBuildQueryComp() {
		try {
			...
			search.setDeloTypeArr(new Integer[] { DocuConstants.CODE_ZNACHENIE_DELO_TYPE_DOSS });
			search.setStatusArr(new Integer[] { DocuConstants.CODE_ZNACHENIE_DELO_STATUS_ACTIVE });
